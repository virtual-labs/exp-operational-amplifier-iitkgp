...
var correct_connections_4_10 = [
 ...
 actual_connections.forEach(function (connection) {
        ...
        actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_11_8){
                is_connected_11_8 = correct_connections_11_8.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
...
actual_connections.forEach(function (connection) {
		...
		actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_5_10){
                is_connected_5_10 = correct_connections_5_10.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
         ...
         if ((is_connected_1_7 || is_connected_1_3) && is_connected_3_7 && is_connected_8_9 && is_connected_11_8 && is_connected_6_12 &&  is_connected_4_5 && (is_connected_4_10 || is_connected_5_10) && !unallowed_connection_present) {
